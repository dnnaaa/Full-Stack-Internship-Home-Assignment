...
public class GlobalException extends Exception implements Serializable {
	...
	public GlobalException(Exception e, MessageSource messageSource, String requestURI) {
		...
		if (e instanceof ClientAbortException) {
			...
			RequiredFieldMissingException requiredFieldMissingException = (RequiredFieldMissingException) e;
			status = HttpStatus.BAD_REQUEST;
			message = messageSource.getMessage(requiredFieldMissingException.getMessage(), requiredFieldMissingException.getParams(), null);
		}
