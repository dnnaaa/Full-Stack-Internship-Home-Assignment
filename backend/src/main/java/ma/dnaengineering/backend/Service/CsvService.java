        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(file.getInputStream()))) {
            ...
            while ((line = reader.readLine()) != null) {
              ...
              //  } catch (NumberFormatException e) {
                // Handle the case where the salary cannot be parsed as an integer
                // For example, you can set a default value or log a warning
                //System.out.println("Warning: Invalid salary format for employee " + employee.getFirstName() + " " + employee.getLastName()+fields[3]);
              //  }
